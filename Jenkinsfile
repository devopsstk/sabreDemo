...
'''
          ...
          "cloudhub": {
            sh 'sudo anypoint-cli --username=msardinas2@Sandbox --password=Softtek.001 runtime-mgr cloudhub-application modify softtek-mule-demo ${WORKSPACE}/target/softtek-demo-1.0.0-SNAPSHOT.zip'
            script {
